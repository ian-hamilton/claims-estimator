...
function(a, b) {
    ...
    ng.moveSelectionHandler = function(a, c, d, e) {
        if (void 0 === a.selectionService.selectedItems) return !0;
        var f, g = d.which || d.keyCode, h = !1, i = !1, j = a.selectionService.lastClickedRow.rowIndex;
        if (a.col && (f = a.col.index), 37 != g && 38 != g && 39 != g && 40 != g && 9 != g && 13 != g) return !0;
        if (a.enableCellSelection) {
            ...
            37 == g || 9 == g && d.shiftKey ? (l && (k && 9 == g && d.shiftKey ? (e.$viewport.scrollLeft(e.$canvas.width()), 
            f = a.columns.length - 1, i = !0) : e.$viewport.scrollLeft(e.$viewport.scrollLeft() - a.col.width)), 
            k || (f -= 1)) : (39 == g || 9 == g && !d.shiftKey) && (m && (n && 9 == g && !d.shiftKey ? (e.$viewport.scrollLeft(0), 
            f = a.showSelectionCheckbox ? 1 : 0, h = !0) : e.$viewport.scrollLeft(e.$viewport.scrollLeft() + a.col.width)), 
            n || (f += 1));
        }
        var o;
        ...
        var p = 0;
        if (0 != j && (38 == g || 13 == g && d.shiftKey || 9 == g && d.shiftKey && i) ? p = -1 : j != o.length - 1 && (40 == g || 13 == g && !d.shiftKey || 9 == g && h) && (p = 1), 
        p) {
            var q = o[j + p];
            q.beforeSelectionChange(q, d) && (q.continueSelection(d), a.$emit("ngGridEventDigestGridParent"), 
            a.selectionService.lastClickedRow.renderedRowIndex >= a.renderedRows.length - b - 2 ? e.$viewport.scrollTop(e.$viewport.scrollTop() + a.rowHeight) : a.selectionService.lastClickedRow.renderedRowIndex <= b + 2 && e.$viewport.scrollTop(e.$viewport.scrollTop() - a.rowHeight));
        }
        ...
        visualLength: function(a) {
            ...
            return b || (b = document.createElement("SPAN"), b.id = "testDataLength", b.style.visibility = "hidden", 
            document.body.appendChild(b)), $(b).css("font", $(a).css("font")), b.innerHTML = $(a).text(), 
            b.offsetWidth;
        },
        forIn: function(a, b) {
        ...
        evalProperty: function(a, b) {
            var c = b.split("."), d = 0, e = a[c[d]], f = c.length;
            for (d++; e && f > d; ) e = e[c[d]], d++;
            return e;
        },
        ...
        ieVersion: function() {
            for (var a = 3, b = document.createElement("div"), c = b.getElementsByTagName("i"); b.innerHTML = "<!--[if gt IE " + ++a + "]><i></i><![endif]-->", 
            c[0]; ) ;
            return a > 4 ? a : void 0;
        }()
    }, $.extend(ng.utils, {
        isIe6: function() {
            return 6 === ng.utils.ieVersion;
        }(),
        isIe7: function() {
            return 7 === ng.utils.ieVersion;
        }(),
        isIe: function() {
            return void 0 !== ng.utils.ieVersion;
        }()
    ...
    }), o.factory("DomUtilityService", function() {
        var a = {}, b = {}, c = function() {
            var b = $("<div></div>");
            b.appendTo("body"), b.height(100).width(100).css("position", "absolute").css("overflow", "scroll"), 
            b.append('<div style="height: 400px; width: 400px;"></div>'), a.ScrollH = b.height() - b[0].clientHeight, 
            a.ScrollW = b.width() - b[0].clientWidth, b.empty(), b.attr("style", ""), b.append('<span style="font-family: Verdana, Helvetica, Sans-Serif; font-size: 14px;"><strong>M</strong></span>'), 
            a.LetterW = b.children().first().width(), b.remove();
        };
        return a.eventStorage = {}, a.AssignGridContainers = function(b, c, d) {
            d.$root = $(c), d.$topPanel = d.$root.find(".ngTopPanel"), d.$groupPanel = d.$root.find(".ngGroupPanel"), 
            d.$headerContainer = d.$topPanel.find(".ngHeaderContainer"), b.$headerContainer = d.$headerContainer, 
            d.$headerScroller = d.$topPanel.find(".ngHeaderScroller"), d.$headers = d.$headerScroller.children(), 
            d.$viewport = d.$root.find(".ngViewport"), d.$canvas = d.$viewport.find(".ngCanvas"), 
            d.$footerPanel = d.$root.find(".ngFooterPanel"), b.$watch(function() {
                return d.$viewport.scrollLeft();
            }, function(a) {
                return d.$headerContainer.scrollLeft(a);
            }), a.UpdateGridLayout(b, d);
        }, a.getRealWidth = function(a) {
            var b = 0, c = {
                visibility: "hidden",
                display: "block"
        ...
        }, a.UpdateGridLayout = function(b, c) {
            var d = c.$viewport.scrollTop();
            c.elementDims.rootMaxW = c.$root.width(), c.$root.is(":hidden") && (c.elementDims.rootMaxW = a.getRealWidth(c.$root)), 
            c.elementDims.rootMaxH = c.$root.height(), c.refreshDomSizes(), b.adjustScrollTop(d, !0);
        }, a.numberOfGrids = 0, a.BuildStyles = function(b, c, d) {
            var e, f = c.config.rowHeight, g = c.$styleSheet, h = c.gridId, i = b.columns, j = 0;
            g || (g = $("#" + h), g[0] || (g = $("<style id='" + h + "' type='text/css' rel='stylesheet' />").appendTo(c.$root))), 
            g.empty();
            var k = b.totalRowWidth();
            e = "." + h + " .ngCanvas { width: " + k + "px; }." + h + " .ngRow { width: " + k + "px; }." + h + " .ngCanvas { width: " + k + "px; }." + h + " .ngHeaderScroller { width: " + (k + a.ScrollH + 2) + "px}";
            for (var l = 0; l < i.length; l++) {
                var m = i[l];
                if (m.visible) {
                    var n = m.pinned ? c.$viewport.scrollLeft() + j : j;
                    e += "." + h + " .col" + l + " { width: " + m.width + "px; left: " + n + "px; height: " + f + "px }." + h + " .colt" + l + " { width: " + m.width + "px; }", 
                    j += m.width;
                }
            }
            ng.utils.isIe ? g[0].styleSheet.cssText = e : g[0].appendChild(document.createTextNode(e)), 
            c.$styleSheet = g, d && (b.adjustScrollLeft(c.$viewport.scrollLeft()), a.digest(b));
        }, a.setColLeft = function(a, c, d) {
            if (d.$styleSheet) {
                var e = b[a.index];
                e || (e = b[a.index] = new RegExp(".col" + a.index + " { width: [0-9]+px; left: [0-9]+px"));
                var f = d.$styleSheet.html(), g = f.replace(e, ".col" + a.index + " { width: " + a.width + "px; left: " + c + "px");
                ng.utils.isIe ? setTimeout(function() {
                    d.$styleSheet.html(g);
                }) : d.$styleSheet.html(g);
            }
        }, a.setColLeft.immediate = 1, a.RebuildGrid = function(b, c) {
            a.UpdateGridLayout(b, c), c.config.maintainColumnRatios && c.configureColumnWidths(), 
            b.adjustScrollLeft(c.$viewport.scrollLeft()), a.BuildStyles(b, c, !0);
        }, a.digest = function(a) {
            a.$root.$$phase || a.$digest();
        }, a.ScrollH = 17, a.ScrollW = 17, a.LetterW = 10, c(), a;
    }), o.factory("SortService", [ "$parse", function(a) {
        var b = {};
        return b.colSortFnCache = {}, b.guessSortFn = function(a) {
            ...
            var c, d, e = !1, f = !1;
            return c = parseFloat(a.replace(/[^0-9.-]/g, "")), isNaN(c) && (e = !0), d = parseFloat(b.replace(/[^0-9.-]/g, "")), 
            isNaN(d) && (f = !0), e && f ? 0 : e ? 1 : f ? -1 : c - d;
            ...
            if (e && c) {
                ...
                e.sort(function(e, k) {
                    for (var l, m = 0, n = 0; 0 == m && h > n; ) {
                        ...
                        !o && 0 != o || !p && 0 != p ? p || o ? o ? p || (m = -1) : m = 1 : m = 0 : m = l(o, p), 
                        n++;
                    }
                    return g === d ? m : 0 - m;
                });
            ...
            var e, f = void 0;
            if (b.colSortFnCache[c.field]) f = b.colSortFnCache[c.field]; else if (void 0 != c.sortingAlgorithm) f = c.sortingAlgorithm, 
            b.colSortFnCache[c.field] = c.sortingAlgorithm; else {
                if (e = d[0], !e) return f;
        ...
        var d = this;
        d.rowIndex = 0, d.offsetTop = d.rowIndex * c, d.entity = a, d.label = a.gLabel, 
        d.field = a.gField, d.depth = a.gDepth, d.parent = a.parent, d.children = a.children, 
        d.aggChildren = a.aggChildren, d.aggIndex = a.aggIndex, d.collapsed = !0, d.isAggRow = !0, 
        d.offsetleft = 25 * a.gDepth, d.aggLabelFilter = a.aggLabelFilter, d.toggleExpand = function() {
            d.collapsed = d.collapsed ? !1 : !0, d.orig && (d.orig.collapsed = d.collapsed), 
            d.notifyChildren();
        }, d.setExpand = function(a) {
            d.collapsed = a, d.notifyChildren();
        }, d.notifyChildren = function() {
            for (var a = Math.max(b.aggCache.length, d.children.length), c = 0; a > c; c++) if (d.aggChildren[c] && (d.aggChildren[c].entity[h] = d.collapsed, 
            d.collapsed && d.aggChildren[c].setExpand(d.collapsed)), d.children[c] && (d.children[c][h] = d.collapsed), 
            c > d.aggIndex && b.aggCache[c]) {
    ...
    }, ng.Column = function(a, b, c, f, g) {
        var h = this, i = a.colDef, k = 500, l = 0, m = null;
        h.width = i.width, h.groupIndex = 0, h.isGroupedBy = !1, h.minWidth = i.minWidth ? i.minWidth : 50, 
        h.maxWidth = i.maxWidth ? i.maxWidth : 9e3, h.enableCellEdit = a.enableCellEdit || i.enableCellEdit, 
        h.headerRowHeight = a.headerRowHeight, h.displayName = i.displayName || i.field, 
        h.index = a.index, h.isAggCol = a.isAggCol, h.cellClass = i.cellClass, h.sortPriority = void 0, 
        h.zIndex = function() {
            return h.pinned ? 5 : 0;
        }, h.cellFilter = i.cellFilter ? i.cellFilter : "", h.field = i.field, h.aggLabelFilter = i.cellFilter || i.aggLabelFilter, 
        h.visible = ng.utils.isNullOrUndefined(i.visible) || i.visible, h.sortable = !1, 
        h.resizable = !1, h.pinnable = !1, h.pinned = i.pinned, h.originalIndex = h.index, 
        h.groupable = ng.utils.isNullOrUndefined(i.groupable) || i.groupable, a.enableSort && (h.sortable = ng.utils.isNullOrUndefined(i.sortable) || i.sortable), 
        a.enableResize && (h.resizable = ng.utils.isNullOrUndefined(i.resizable) || i.resizable), 
        a.enablePinning && (h.pinnable = ng.utils.isNullOrUndefined(i.pinnable) || i.pinnable), 
        h.sortDirection = void 0, h.sortingAlgorithm = i.sortFn, h.headerClass = i.headerClass, 
        h.cursor = h.sortable ? "pointer" : "default", h.headerCellTemplate = i.headerCellTemplate || g.get("headerCellTemplate.html"), 
        h.cellTemplate = i.cellTemplate || g.get("cellTemplate.html").replace(j, h.cellFilter ? "|" + h.cellFilter : ""), 
        h.enableCellEdit && (h.cellEditTemplate = g.get("cellEditTemplate.html"), h.editableCellTemplate = i.editableCellTemplate || g.get("editableCellTemplate.html")), 
        i.cellTemplate && !n.test(i.cellTemplate) && (h.cellTemplate = $.ajax({
            type: "GET",
            url: i.cellTemplate,
            async: !1
        }).responseText), h.enableCellEdit && i.editableCellTemplate && !n.test(i.editableCellTemplate) && (h.editableCellTemplate = $.ajax({
            type: "GET",
            url: i.editableCellTemplate,
            async: !1
        }).responseText), i.headerCellTemplate && !n.test(i.headerCellTemplate) && (h.headerCellTemplate = $.ajax({
            type: "GET",
            url: i.headerCellTemplate,
            async: !1
        }).responseText), h.colIndex = function() {
            return "col" + h.index + " colt" + h.index;
        }, h.groupedByClass = function() {
            return h.isGroupedBy ? "ngGroupedByIcon" : "ngGroupIcon";
        }, h.toggleVisible = function() {
            h.visible = !h.visible;
        }, h.showSortButtonUp = function() {
            return h.sortable ? h.sortDirection === e : h.sortable;
        }, h.showSortButtonDown = function() {
            return h.sortable ? h.sortDirection === d : h.sortable;
        }, h.noSortVisible = function() {
            return !h.sortDirection;
        }, h.sort = function(b) {
            if (!h.sortable) return !0;
            var c = h.sortDirection === d ? e : d;
            return h.sortDirection = c, a.sortCallback(h, b), !1;
        }, h.gripClick = function() {
            l++, 1 === l ? m = setTimeout(function() {
                l = 0;
            }, k) : (clearTimeout(m), a.resizeOnDataCallback(h), l = 0);
        }, h.gripOnMouseDown = function(a) {
            return a.ctrlKey && !h.pinned ? (h.toggleVisible(), f.BuildStyles(b, c), !0) : (a.target.parentElement.style.cursor = "col-resize", 
            h.startMousePosition = a.clientX, h.origWidth = h.width, $(document).mousemove(h.onMouseMove), 
            $(document).mouseup(h.gripOnMouseUp), !1);
        }, h.onMouseMove = function(a) {
            var d = a.clientX - h.startMousePosition, e = d + h.origWidth;
            return h.width = e < h.minWidth ? h.minWidth : e > h.maxWidth ? h.maxWidth : e, 
            f.BuildStyles(b, c), !1;
        }, h.gripOnMouseUp = function(a) {
            return $(document).off("mousemove", h.onMouseMove), $(document).off("mouseup", h.gripOnMouseUp), 
            a.target.parentElement.style.cursor = "default", b.adjustScrollLeft(0), f.digest(b), 
            !1;
        }, h.copy = function() {
            var d = new ng.Column(a, b, c, f, g);
            return d.isClone = !0, d.orig = h, d;
        }, h.setVars = function(a) {
            h.orig = a, h.width = a.width, h.groupIndex = a.groupIndex, h.isGroupedBy = a.isGroupedBy, 
            h.displayName = a.displayName, h.index = a.index, h.isAggCol = a.isAggCol, h.cellClass = a.cellClass, 
            h.cellFilter = a.cellFilter, h.field = a.field, h.aggLabelFilter = a.aggLabelFilter, 
            h.visible = a.visible, h.sortable = a.sortable, h.resizable = a.resizable, h.pinnable = a.pinnable, 
            h.pinned = a.pinned, h.originalIndex = a.originalIndex, h.sortDirection = a.sortDirection, 
            h.sortingAlgorithm = a.sortingAlgorithm, h.headerClass = a.headerClass, h.headerCellTemplate = a.headerCellTemplate, 
            h.cellTemplate = a.cellTemplate, h.cellEditTemplate = a.cellEditTemplate;
        };
        ...
        c.selectInputElement = function(a) {
            ...
            if (c.selectionService.lastClickedRow) {
                var e = void 0 != d ? d : b, f = c.selectionService.lastClickedRow.clone ? c.selectionService.lastClickedRow.clone.elm : c.selectionService.lastClickedRow.elm;
                if (void 0 != e && f) {
                    ...
                    a.config.showSelectionCheckbox && angular.element(g[h]).scope() && 0 == angular.element(g[h]).scope().col.index && (h = 1), 
                    g[h] && g[h].children[0].focus(), b = e;
                }
            }
        };
        var d = function(a, b) {
        ...
        c.selectionHandlers = function(b, c) {
            ...
            c.bind("keydown", function(f) {
                if (16 == f.keyCode) return d(c, "none", f), !0;
                if (!e) {
                    e = !0;
        ...
        e.colToMove = void 0, e.groupToMove = void 0, e.assignEvents = function() {
            ...
            }), c.$evalAsync(e.setDraggables)) : (b.$groupPanel.on("mousedown", e.onGroupMouseDown).on("dragover", e.dragOver).on("drop", e.onGroupDrop), 
            b.$headerScroller.on("mousedown", e.onHeaderMouseDown).on("dragover", e.dragOver), 
            b.config.enableColumnReordering && !b.config.enablePinning && b.$headerScroller.on("drop", e.onHeaderDrop), 
            b.config.enableRowReordering && b.$viewport.on("mousedown", e.onRowMouseDown).on("dragover", e.dragOver).on("drop", e.onRowDrop)), 
            c.$watch("columns", e.setDraggables, !0);
        }, e.dragStart = function(a) {
            a.dataTransfer.setData("text", "");
        }, e.dragOver = function(a) {
            a.preventDefault();
        }, e.setDraggables = function() {
            if (b.config.jqueryUIDraggable) b.$root.find(".ngHeaderSortColumn").draggable({
                helper: "clone",
                appendTo: "body",
                stack: "div",
                addClasses: !1,
            ...
            if ("ngRemoveGroup" != c[0].className) {
                ...
                d && (b.config.jqueryUIDraggable || (c.attr("draggable", "true"), this.addEventListener && this.addEventListener("dragstart", e.dragStart), 
                -1 != navigator.userAgent.indexOf("MSIE") && c.bind("selectstart", function() {
                    return this.dragDrop(), !1;
                })), e.groupToMove = {
                    header: c,
                    groupName: d.group,
            ...
            } else e.groupToMove = void 0;
        }, e.onGroupDrop = function(a) {
            a.stopPropagation();
            var d, f;
            e.groupToMove ? (d = $(a.target).closest(".ngGroupElement"), "ngGroupPanel" == d.context.className ? (c.configGroups.splice(e.groupToMove.index, 1), 
            c.configGroups.push(e.groupToMove.groupName)) : (f = angular.element(d).scope(), 
            f && e.groupToMove.index != f.$index && (c.configGroups.splice(e.groupToMove.index, 1), 
            c.configGroups.splice(f.$index, 0, e.groupToMove.groupName))), e.groupToMove = void 0, 
            b.fixGroupIndexes()) : e.colToMove && (-1 == c.configGroups.indexOf(e.colToMove.col) && (d = $(a.target).closest(".ngGroupElement"), 
            "ngGroupPanel" == d.context.className || "ngGroupPanelDescription ng-binding" == d.context.className ? c.groupBy(e.colToMove.col) : (f = angular.element(d).scope(), 
            f && c.removeGroup(f.$index))), e.colToMove = void 0), c.$$phase || c.$apply();
            ...
            if (e.colToMove) {
                ...
                if (g) {
                    if (e.colToMove.col == g.col) return;
                    c.columns.splice(e.colToMove.col.index, 1), c.columns.splice(g.col.index, 0, e.colToMove.col), 
                    b.fixColumnIndexes(), d.BuildStyles(c, b, !0), e.colToMove = void 0;
                }
            }
            ...
            if (e) {
                ...
                if (f.scope.row == e.row) return;
                b.changeRowOrder(f.scope.row, e.row), b.searchProvider.evalFilter(), d.eventStorage.rowToMove = void 0, 
                d.digest(e.$root);
            }
        }, e.assignGridEventHandlers = function() {
            -1 === b.config.tabIndex ? (b.$viewport.attr("tabIndex", d.numberOfGrids), d.numberOfGrids++) : b.$viewport.attr("tabIndex", b.config.tabIndex), 
            $(a).resize(function() {
                d.RebuildGrid(c, b);
            });
        ...
        a.maxRows = function() {
            ...
            return c;
        }, a.multiSelect = b.config.enableRowSelection && b.config.multiSelect, a.selectedItemCount = b.selectedItemCount, 
        a.maxPages = function() {
        ...
        l.maxCanvasHt = 0, l.config = $.extend(k, a.ngGrid.config, e), l.config.showSelectionCheckbox = l.config.showSelectionCheckbox && l.config.enableColumnHeavyVirt === !1, 
        l.config.enablePinning = l.config.enablePinning && l.config.enableColumnHeavyVirt === !1, 
        l.config.selectWithCheckboxOnly = l.config.selectWithCheckboxOnly && l.config.showSelectionCheckbox !== !1, 
        l.config.pinSelectionCheckbox = l.config.enablePinning, "string" == typeof e.columnDefs && (l.config.columnDefs = d.$eval(e.columnDefs)), 
        l.rowCache = [], l.rowMap = [], l.gridId = "ng" + ng.utils.newId(), l.$root = null, 
        l.$groupPanel = null, l.$topPanel = null, l.$headerContainer = null, l.$headerScroller = null, 
        l.$headers = null, l.$viewport = null, l.$canvas = null, l.rootDim = l.config.gridDim, 
        l.sortInfo = l.config.sortInfo, l.data = [], l.lateBindColumns = !1, l.filteredRows = [];
        var m = function(a) {
            var b = l.config[a], c = l.gridId + a + ".html";
            if (b && !n.test(b)) j.put(c, $.ajax({
                type: "GET",
                url: b,
                async: !1
            }).responseText); else if (b) j.put(c, b); else {
                var d = a + ".html";
                j.put(c, j.get(d));
            }
        };
        m("rowTemplate"), m("aggregateTemplate"), m("headerRowTemplate"), m("checkboxCellTemplate"), 
        m("checkboxHeaderTemplate"), "object" == typeof l.config.data && (l.data = l.config.data), 
        l.calcMaxCanvasHeight = function() {
            return l.config.groups.length > 0 ? l.rowFactory.parsedData.filter(function(a) {
                return !a[h];
            }).length * l.config.rowHeight : l.filteredRows.length * l.config.rowHeight;
        }, l.elementDims = {
            scrollW: 0,
            scrollH: 0,
            rowIndexCellW: 25,
            ...
            rootMaxW: 0,
            rootMaxH: 0
        }, l.setRenderedRows = function(a) {
            d.renderedRows.length = a.length;
            for (var b = 0; b < a.length; b++) !d.renderedRows[b] || a[b].isAggRow || d.renderedRows[b].isAggRow ? (d.renderedRows[b] = a[b].copy(), 
            d.renderedRows[b].collapsed = a[b].collapsed, a[b].isAggRow || d.renderedRows[b].setVars(a[b])) : d.renderedRows[b].setVars(a[b]), 
            d.renderedRows[b].rowIndex = a[b].rowIndex, d.renderedRows[b].offsetTop = a[b].offsetTop, 
            a[b].renderedRowIndex = b;
            l.refreshDomSizes(), d.$emit("ngGridEventRows", a);
        }, l.minRowsToRender = function() {
            var a = d.viewportDimHeight() || 1;
            return Math.floor(a / l.config.rowHeight);
        }, l.refreshDomSizes = function() {
            var a = new ng.Dimension();
            a.outerWidth = l.elementDims.rootMaxW, a.outerHeight = l.elementDims.rootMaxH, l.rootDim = a, 
            l.maxCanvasHt = l.calcMaxCanvasHeight();
        }, l.buildColumnDefsFromData = function() {
            l.config.columnDefs = [];
            var a = l.data[0];
            return a ? void ng.utils.forIn(a, function(a, b) {
                -1 == l.config.excludeProperties.indexOf(b) && l.config.columnDefs.push({
                    field: b
                });
            }) : void (l.lateBoundColumns = !0);
        }, l.buildColumns = function() {
            var a = l.config.columnDefs, b = [];
            if (a || (l.buildColumnDefsFromData(), a = l.config.columnDefs), l.config.showSelectionCheckbox && b.push(new ng.Column({
                colDef: {
                    field: "✔",
                    width: l.elementDims.rowSelectedCellW,
                    sortable: !1,
                    resizable: !1,
                    groupable: !1,
                    headerCellTemplate: j.get(d.gridId + "checkboxHeaderTemplate.html"),
                    cellTemplate: j.get(d.gridId + "checkboxCellTemplate.html"),
                    pinned: l.config.pinSelectionCheckbox
                },
                index: 0,
                headerRowHeight: l.config.headerRowHeight,
                sortCallback: l.sortData,
                resizeOnDataCallback: l.resizeOnData,
                enableResize: l.config.enableColumnResize,
                enableSort: l.config.enableSorting
            }, d, l, g, j)), a.length > 0) {
                var c = l.config.showSelectionCheckbox ? l.config.groups.length + 1 : l.config.groups.length;
                d.configGroups.length = 0, angular.forEach(a, function(a, e) {
                    ...
                    var f = new ng.Column({
                        ...
                        enableResize: l.config.enableColumnResize,
                        enableSort: l.config.enableSorting,
                        enablePinning: l.config.enablePinning,
                        enableCellEdit: l.config.enableCellEdit
                    }, d, l, g, j), h = l.config.groups.indexOf(a.field);
                    -1 != h && (f.isGroupedBy = !0, d.configGroups.splice(h, 0, f), f.groupIndex = d.configGroups.length), 
                    b.push(f);
                }), d.columns = b;
            }
        }, l.configureColumnWidths = function() {
            var a = l.config.columnDefs, b = l.config.showSelectionCheckbox ? d.configGroups.length + 1 : d.configGroups.length, c = a.length + b, e = [], f = [], h = 0, i = 0;
            if (i += l.config.showSelectionCheckbox ? 25 : 0, angular.forEach(a, function(a, c) {
                c += b;
                var g = !1, j = void 0;
                if (ng.utils.isNullOrUndefined(a.width) ? a.width = "*" : (g = isNaN(a.width) ? ng.utils.endsWith(a.width, "%") : !1, 
                j = g ? a.width : parseInt(a.width, 10)), isNaN(j)) {
                    if (j = a.width, "auto" == j) {
                    ...
                    if (-1 != j.indexOf("*")) return h += j.length, a.index = c, void e.push(a);
                    if (g) return a.index = c, void f.push(a);
                    throw 'unable to parse column width, use percentage ("10%","20%", etc...) or "*" to use remaining width of grid';
                }
                i += d.columns[c].width = parseInt(a.width, 10);
            }), e.length > 0) {
                l.config.maintainColumnRatios === !1 ? angular.noop() : l.config.maintainColumnRatios = !0;
                var j = l.rootDim.outerWidth - i, k = Math.floor(j / h);
                angular.forEach(e, function(a) {
                    var b = a.width.length;
                    if (d.columns[a.index].width = k * b, a.index + 1 == c) {
                        var e = 2;
                        l.maxCanvasHt > d.viewportDimHeight() && (e += g.ScrollW), d.columns[a.index].width -= e;
                    }
                    i += d.columns[a.index].width;
                });
            }
            f.length > 0 && angular.forEach(f, function(a) {
                var b = a.width;
                d.columns[a.index].width = Math.floor(l.rootDim.outerWidth * (parseInt(b.slice(0, -1), 10) / 100));
            });
        }, l.init = function() {
            d.selectionService = new ng.SelectionService(l, d), d.domAccessProvider = new ng.DomAccessProvider(l), 
            l.rowFactory = new ng.RowFactory(l, d, g, j), l.searchProvider = new ng.SearchProvider(d, l, i), 
            l.styleProvider = new ng.StyleProvider(d, l, g), d.$watch("configGroups", function(a) {
                var b = [];
                angular.forEach(a, function(a) {
                    b.push(a.field || a);
                }), l.config.groups = b, l.rowFactory.filteredRowsChanged(), d.$emit("ngGridEventGroups", a);
            }, !0), d.$watch("columns", function(a) {
                g.BuildStyles(d, l, !0), d.$emit("ngGridEventColumns", a);
            }, !0), d.$watch(function() {
                return e.i18n;
            }, function(a) {
                ng.utils.seti18n(d, a);
            }), l.maxCanvasHt = l.calcMaxCanvasHeight(), l.config.sortInfo && d.columns.length && (l.config.sortInfo.columns = d.columns.filter(function(a) {
                return -1 != l.config.sortInfo.field.indexOf(a.field) ? !0 : !1;
            }), l.config.sortInfo.column.sortDirection = l.config.sortInfo.direction.toUpperCase(), 
            l.sortData(l.config.sortInfo.columns));
        }, l.resizeOnData = function(a) {
            var b = a.minWidth, c = ng.utils.getElementsByClassName("col" + a.index);
            angular.forEach(c, function(a, c) {
                var d;
                if (0 === c) {
                    var e = $(a).find(".ngHeaderText");
                    d = ng.utils.visualLength(e) + 10;
                } else {
                    var f = $(a).find(".ngCellText");
                    d = ng.utils.visualLength(f) + 10;
                }
                d > b && (b = d);
            }), a.width = a.longest = Math.min(a.maxWidth, b + 7), g.BuildStyles(d, l, !0);
        }, l.lastSortedColumns = [], l.changeRowOrder = function(a, b) {
            var c = l.rowCache.indexOf(a), e = l.rowCache.indexOf(b);
            l.rowCache.splice(c, 1), l.rowCache.splice(e, 0, a), d.$emit("ngGridEventChangeOrder", l.rowCache);
        }, l.sortData = function(a, b) {
            if (b.shiftKey && l.config.sortInfo) {
                var c = l.config.sortInfo.columns.indexOf(a);
                -1 === c ? (1 == l.config.sortInfo.columns.length && (l.config.sortInfo.columns[0].sortPriority = 1), 
                l.config.sortInfo.columns.push(a), a.sortPriority = l.config.sortInfo.columns.length, 
                l.config.sortInfo.fields.push(a.field), l.config.sortInfo.directions.push(a.sortDirection), 
                l.lastSortedColumns.push(a)) : l.config.sortInfo.directions[c] = a.sortDirection;
            } else {
                var e = $.isArray(a);
                l.config.sortInfo = {
                    columns: [],
                ...
                var g = function(a) {
                    l.config.sortInfo.columns.push(a), l.config.sortInfo.fields.push(a.field), l.config.sortInfo.directions.push(a.sortDirection), 
                    l.lastSortedColumns.push(a);
                };
                e ? (l.clearSortingData(), angular.forEach(a, function(a, b) {
                    a.sortPriority = b + 1, g(a);
                })) : (l.clearSortingData(a), a.sortPriority = void 0, g(a));
            }
            if (!l.config.useExternalSorting) {
                var h = l.data.slice(0);
                angular.forEach(h, function(a, b) {
                    a.preSortSelected = l.rowCache[l.rowMap[b]].selected, a.preSortIndex = b;
                }), f.Sort(l.config.sortInfo, h), angular.forEach(h, function(a, b) {
                    l.rowCache[b].entity = a, l.rowCache[b].selected = a.preSortSelected, l.rowMap[a.preSortIndex] = b, 
                    delete a.preSortSelected, delete a.preSortIndex;
                });
            }
            l.searchProvider.evalFilter(), d.$emit("ngGridEventSorted", a);
        }, l.clearSortingData = function(a) {
            a ? (angular.forEach(l.lastSortedColumns, function(b) {
                a.index != b.index && (b.sortDirection = "", b.sortPriority = null);
            }), l.lastSortedColumns[0] = a, l.lastSortedColumns.length = 1) : (angular.forEach(l.lastSortedColumns, function(a) {
                a.sortDirection = "", a.sortPriority = null;
            }), l.lastSortedColumns = []);
        }, l.fixColumnIndexes = function() {
            for (var a = 0; a < d.columns.length; a++) d.columns[a].visible && (d.columns[a].index = a);
        }, l.fixGroupIndexes = function() {
            angular.forEach(d.configGroups, function(a, b) {
                a.groupIndex = b + 1;
            });
        }, d.elementsNeedMeasuring = !0, d.columns = [], d.renderedRows = [], d.renderedColumns = [], 
        d.headerRow = null, d.rowHeight = l.config.rowHeight, d.jqueryUITheme = l.config.jqueryUITheme, 
        d.showSelectionCheckbox = l.config.showSelectionCheckbox, d.enableCellSelection = l.config.enableCellSelection, 
        d.footer = null, d.selectedItems = l.config.selectedItems, d.multiSelect = l.config.multiSelect, 
        d.showFooter = l.config.showFooter, d.footerRowHeight = d.showFooter ? l.config.footerRowHeight : 0, 
        d.showColumnMenu = l.config.showColumnMenu, d.showMenu = !1, d.configGroups = [], 
        d.gridId = l.gridId, d.enablePaging = l.config.enablePaging, d.pagingOptions = l.config.pagingOptions, 
        d.i18n = {}, ng.utils.seti18n(d, l.config.i18n), d.adjustScrollLeft = function(a) {
            for (var b = 0, c = 0, e = d.columns.length, f = [], h = !l.config.enableColumnHeavyVirt, i = 0, j = function(a) {
                h ? f.push(a) : d.renderedColumns[i] ? d.renderedColumns[i].setVars(a) : d.renderedColumns[i] = a.copy(), 
                i++;
            }, k = 0; e > k; k++) {
                var m = d.columns[k];
                if (m.visible) {
                    ...
                    if (m.pinned) {
                        j(m);
                        var o = k > 0 ? a + c : a;
                        g.setColLeft(m, o, l), c += m.width;
                    } else n >= a && b <= a + l.rootDim.outerWidth && j(m);
                    b += m.width;
                }
            }
            h && (d.renderedColumns = f);
        }, l.prevScrollTop = 0, l.prevScrollIndex = 0, d.adjustScrollTop = function(a, e) {
            if (l.prevScrollTop !== a || e) {
                a > 0 && l.$viewport[0].scrollHeight - a <= l.$viewport.outerHeight() && d.$emit("ngGridEventScroll");
                var f, g = Math.floor(a / l.config.rowHeight);
                if (l.filteredRows.length > l.config.virtualizationThreshold) {
                    if (l.prevScrollTop < a && g < l.prevScrollIndex + c) return;
                    if (l.prevScrollTop > a && g > l.prevScrollIndex - c) return;
                    f = new ng.Range(Math.max(0, g - b), g + l.minRowsToRender() + b);
                } else {
                    var h = d.configGroups.length > 0 ? l.rowFactory.parsedData.length : l.data.length;
                    f = new ng.Range(0, Math.max(h, l.minRowsToRender() + b));
                }
                l.prevScrollTop = a, l.rowFactory.UpdateViewableRange(f), l.prevScrollIndex = g;
            }
        }, d.toggleShowMenu = function() {
            d.showMenu = !d.showMenu;
        }, d.toggleSelectAll = function(a) {
            d.selectionService.toggleSelectAll(a);
        }, d.totalFilteredItemsLength = function() {
            return l.filteredRows.length;
        }, d.showGroupPanel = function() {
            return l.config.showGroupPanel;
        }, d.topPanelHeight = function() {
            return l.config.showGroupPanel === !0 ? l.config.headerRowHeight + 32 : l.config.headerRowHeight;
        }, d.viewportDimHeight = function() {
            return Math.max(0, l.rootDim.outerHeight - d.topPanelHeight() - d.footerRowHeight - 2);
        }, d.groupBy = function(a) {
            if (a.sortDirection || a.sort({
                shiftKey: !1
            }), !(l.data.length < 1) && a.groupable && a.field) {
                var b = d.configGroups.indexOf(a);
                -1 == b ? (a.isGroupedBy = !0, d.configGroups.push(a), a.groupIndex = d.configGroups.length) : d.removeGroup(b), 
                l.$viewport.scrollTop(0), g.digest(d);
            }
        }, d.removeGroup = function(a) {
            var b = d.columns.filter(function(b) {
                return b.groupIndex == a + 1;
            })[0];
            b.isGroupedBy = !1, b.groupIndex = 0, d.columns[a].isAggCol && (d.columns.splice(a, 1), 
            d.configGroups.splice(a, 1), l.fixGroupIndexes()), 0 === d.configGroups.length && (l.fixColumnIndexes(), 
            g.digest(d)), d.adjustScrollLeft(0);
        }, d.togglePin = function(a) {
            for (var b = a.index, c = 0, e = 0; e < d.columns.length && d.columns[e].pinned; e++) c++;
            a.pinned && (c = Math.max(a.originalIndex, c - 1)), a.pinned = !a.pinned, d.columns.splice(b, 1), 
            d.columns.splice(c, 0, a), l.fixColumnIndexes(), g.BuildStyles(d, l, !0), l.$viewport.scrollLeft(l.$viewport.scrollLeft() - a.width);
        }, d.totalRowWidth = function() {
            for (var a = 0, b = d.columns, c = 0; c < b.length; c++) b[c].visible && (a += b[c].width);
            return a;
        }, d.headerScrollerDim = function() {
            var a = d.viewportDimHeight(), b = l.maxCanvasHt, c = b > a, e = new ng.Dimension();
            return e.autoFitHeight = !0, e.outerWidth = d.totalRowWidth(), c ? e.outerWidth += l.elementDims.scrollW : b - a <= l.elementDims.scrollH && (e.outerWidth += l.elementDims.scrollW), 
            e;
        }, l.init();
    }, ng.Range = function(a, b) {
        this.topRow = a, this.bottomRow = b;
    }, ng.Row = function(a, b, c, d) {
        var e = this, f = b.enableRowSelection;
        e.jqueryUITheme = b.jqueryUITheme, e.rowClasses = b.rowClasses, e.entity = a, e.selectionService = c, 
        e.selected = c.getSelection(a), e.cursor = f ? "pointer" : "default", e.setSelection = function(a) {
            e.selectionService.setSelection(e, a), e.selectionService.lastClickedRow = e;
        }, e.continueSelection = function(a) {
            e.selectionService.ChangeSelection(e, a);
        }, e.ensureEntity = function(a) {
            e.entity != a && (e.entity = a, e.selected = e.selectionService.getSelection(e.entity));
        }, e.toggleSelected = function(a) {
            if (!f && !b.enableCellSelection) return !0;
            var c = a.target || a;
            return "checkbox" == c.type && "ngSelectionCell ng-scope" != c.parentElement.className ? !0 : b.selectWithCheckboxOnly && "checkbox" != c.type ? (e.selectionService.lastClickedRow = e, 
            !0) : (e.beforeSelectionChange(e, a) && e.continueSelection(a), !1);
        }, e.rowIndex = d, e.offsetTop = e.rowIndex * b.rowHeight, e.rowDisplayIndex = 0, 
        e.alternatingRowClass = function() {
            var a = e.rowIndex % 2 === 0, b = {
                selected: e.selected,
                "ui-state-default": e.jqueryUITheme && a,
                "ui-state-active": e.jqueryUITheme && !a,
                even: a,
                odd: !a
            };
            return b;
        }, e.beforeSelectionChange = b.beforeSelectionChangeCallback, e.afterSelectionChange = b.afterSelectionChangeCallback, 
        e.getProperty = function(a) {
            return ng.utils.evalProperty(e.entity, a);
        }, e.copy = function() {
            return e.clone = new ng.Row(a, b, c, d), e.clone.isClone = !0, e.clone.elm = e.elm, 
            e.clone;
        }, e.setVars = function(a) {
            a.clone = e, e.entity = a.entity, e.selected = a.selected;
        };
    }, ng.RowFactory = function(a, c, d, e) {
        var j = this;
        j.aggCache = {}, j.parentCache = [], j.dataChanged = !0, j.parsedData = [], j.rowConfig = {}, 
        j.selectionService = c.selectionService, j.rowHeight = 30, j.numberOfAggregates = 0, 
        j.groupedData = void 0, j.rowHeight = a.config.rowHeight, j.rowConfig = {
        ...
        }, j.renderedRange = new ng.Range(0, a.minRowsToRender() + b), j.buildEntityRow = function(a, b) {
            return new ng.Row(a, j.rowConfig, j.selectionService, b);
        }, j.buildAggregateRow = function(a, b) {
            var c = j.aggCache[a.aggIndex];
            return c || (c = new ng.Aggregate(a, j, j.rowConfig.rowHeight), j.aggCache[a.aggIndex] = c), 
            c.rowIndex = b, c.offsetTop = b * j.rowConfig.rowHeight, c;
        }, j.UpdateViewableRange = function(a) {
            j.renderedRange = a, j.renderedChange();
        }, j.filteredRowsChanged = function() {
            a.lateBoundColumns && a.filteredRows.length > 0 && (a.config.columnDefs = void 0, 
            a.buildColumns(), a.lateBoundColumns = !1, c.$evalAsync(function() {
                c.adjustScrollLeft(0);
            })), j.dataChanged = !0, a.config.groups.length > 0 && j.getGrouping(a.config.groups), 
            j.UpdateViewableRange(j.renderedRange);
        }, j.renderedChange = function() {
            if (!j.groupedData || a.config.groups.length < 1) return j.renderedChangeNoGroups(), 
            void a.refreshDomSizes();
            j.wasGrouped = !0, j.parentCache = [];
            var b = 0, c = j.parsedData.filter(function(a) {
                return a.isAggRow ? a.parent && a.parent.collapsed ? !1 : !0 : (a[h] || (a.rowIndex = b++), 
                !a[h]);
            });
            j.totalRows = c.length;
            for (var d = [], e = j.renderedRange.topRow; e < j.renderedRange.bottomRow; e++) c[e] && (c[e].offsetTop = e * a.config.rowHeight, 
            d.push(c[e]));
            a.setRenderedRows(d);
        }, j.renderedChangeNoGroups = function() {
            for (var b = [], c = j.renderedRange.topRow; c < j.renderedRange.bottomRow; c++) a.filteredRows[c] && (a.filteredRows[c].rowIndex = c, 
            a.filteredRows[c].offsetTop = c * a.config.rowHeight, b.push(a.filteredRows[c]));
            a.setRenderedRows(b);
        }, j.fixRowCache = function() {
            var b = a.data.length, c = b - a.rowCache.length;
            if (0 > c) a.rowCache.length = a.rowMap.length = b; else for (var d = a.rowCache.length; b > d; d++) a.rowCache[d] = a.rowFactory.buildEntityRow(a.data[d], d);
        }, j.parseGroupData = function(a) {
            if (a.values) for (var b = 0; b < a.values.length; b++) j.parentCache[j.parentCache.length - 1].children.push(a.values[b]), 
            j.parsedData.push(a.values[b]); else for (var c in a) if (c != f && c != g && c != i && a.hasOwnProperty(c)) {
                var d = j.buildAggregateRow({
                    gField: a[f],
                    gLabel: c,
                    gDepth: a[g],
                    isAggRow: !0,
                    ...
                    children: [],
                    aggChildren: [],
                    aggIndex: j.numberOfAggregates,
                    aggLabelFilter: a[i].aggLabelFilter
                }, 0);
                j.numberOfAggregates++, d.parent = j.parentCache[d.depth - 1], d.parent && (d.parent.collapsed = !1, 
                d.parent.aggChildren.push(d)), j.parsedData.push(d), j.parentCache[d.depth] = d, 
                j.parseGroupData(a[c]);
            }
        }, j.getGrouping = function(b) {
            j.aggCache = [], j.numberOfAggregates = 0, j.groupedData = {};
            for (var k = a.filteredRows, l = b.length, m = c.columns, n = 0; n < k.length; n++) {
                var o = k[n].entity;
                if (!o) return;
                k[n][h] = !0;
                for (var p = j.groupedData, q = 0; q < b.length; q++) {
                    var r = b[q], s = m.filter(function(a) {
                        return a.field == r;
                    })[0], t = ng.utils.evalProperty(o, r);
                    t = t ? t.toString() : "null", p[t] || (p[t] = {}), p[f] || (p[f] = r), p[g] || (p[g] = q), 
                    p[i] || (p[i] = s), p = p[t];
                }
                p.values || (p.values = []), p.values.push(k[n]);
            }
            for (var u = 0; u < b.length; u++) !m[u].isAggCol && l >= u && m.splice(0, 0, new ng.Column({
                colDef: {
                    field: "",
                    width: 25,
                    sortable: !1,
            ...
            d.BuildStyles(c, a, !0), a.fixColumnIndexes(), c.adjustScrollLeft(0), j.parsedData.length = 0, 
            j.parseGroupData(j.groupedData), j.fixRowCache();
        }, a.config.groups.length > 0 && a.filteredRows.length > 0 && j.getGrouping(a.config.groups);
    }, ng.SearchProvider = function(a, b, c) {
        var d = this, e = [];
        d.extFilter = b.config.filterOptions.useExternalFilter, a.showFilter = b.config.showFilter, 
        a.filterText = "", d.fieldMap = {}, d.evalFilter = function() {
            var a = function(a) {
                for (var b = 0, g = e.length; g > b; b++) {
                    ...
                    if (!i.column) {
                        for (var j in a) if (a.hasOwnProperty(j)) {
                            ...
                            var l = null;
                            if (k && k.cellFilter) {
                                var m = k.cellFilter.split(":");
                                l = c(m[0]);
                            }
                            var n = a[j];
                            if (null != n) {
                                if ("function" == typeof l) {
                                    var o = l("object" == typeof n ? f(n, k.field) : n).toString();
                                    h = i.regex.test(o);
                                } else h = i.regex.test("object" == typeof n ? f(n, k.field).toString() : n.toString());
                                if (n && h) return !0;
                            }
                        }
                        return !1;
                    ...
                    if (!p) return !1;
                    var q = p.cellFilter ? c(p.cellFilter) : null, r = a[i.column] || a[p.field.split(".")[0]];
                    if (null == r) return !1;
                    if ("function" == typeof q) {
                        var s = q("object" == typeof r ? f(r, p.field) : r).toString();
                        h = i.regex.test(s);
                    } else h = i.regex.test("object" == typeof r ? f(r, p.field).toString() : r.toString());
                    if (!r || !h) return !1;
                }
                return !0;
            };
            ...
            for (var g = 0; g < b.filteredRows.length; g++) b.filteredRows[g].rowIndex = g;
        ...
        var f = function(a, b) {
            ...
            var c = b.split("."), d = a;
            if (c.length > 1) {
                for (var e = 1, f = c.length; f > e; e++) if (d = d[c[e]], !d) return a;
                return d;
            }
            return a;
        }, g = function(a, b) {
            ...
            e = [];
            var b;
            if (b = $.trim(a)) for (var c = b.split(";"), d = 0; d < c.length; d++) {
                var f = c[d].split(":");
                if (f.length > 1) {
    ...
    }, ng.SelectionService = function(a, b) {
        var c = this;
        c.multi = a.config.multiSelect, c.selectedItems = a.config.selectedItems, c.selectedIndex = a.config.selectedIndex, 
        c.lastClickedRow = void 0, c.ignoreSelectedItemChanges = !1, c.ChangeSelection = function(d, e) {
            ...
            if (e && e.shiftKey && !e.keyCode && c.multi && a.config.enableRowSelection) {
                if (c.lastClickedRow) {
                    ...
                    if (c.lastClickedRow = f, h == i) return !1;
                    i > h ? (h ^= i, i = h ^ i, h ^= i, h--) : i++;
                    for (var j = []; h >= i; i++) j.push(g[i]);
            ...
            } else c.multi ? e.keyCode || c.setSelection(f, !f.selected) : c.lastClickedRow == f ? c.setSelection(c.lastClickedRow, a.config.keepLastSelected ? !0 : !f.selected) : (c.lastClickedRow && c.setSelection(c.lastClickedRow, !1), 
            c.setSelection(f, !f.selected));
            ...
            if (a.config.enableRowSelection) {
                if (e.selected = d, e.clone && (e.clone.selected = d), d) -1 === c.selectedItems.indexOf(e.entity) && (!c.multi && c.selectedItems.length > 0 && (c.toggleSelectAll(!1, !0), 
                e.selected = d, e.clone && (e.clone.selected = d)), c.selectedItems.push(e.entity)); else {
            ...
            if (d || a.config.beforeSelectionChange(a.filteredRows)) {
                ...
                for (var f = 0; f < a.filteredRows.length; f++) a.filteredRows[f].selected = b, 
                a.filteredRows[f].clone && (a.filteredRows[f].clone.selected = b), b && c.selectedItems.push(a.filteredRows[f].entity);
        ...
        a.headerCellStyle = function(a) {
            ...
            return {
                height: b.maxCanvasHt.toString() + "px"
            };
    ...
    }, p.directive("ngCellHasFocus", [ "DomUtilityService", function(a) {
        var b = function(b, c) {
            b.isFocused = !0, a.digest(b);
            var d = angular.element(c[0].children).filter(function() {
                return 8 != this.nodeType;
            }), e = angular.element(d[0].children[0]);
            e.length > 0 && (angular.element(e).focus(), b.domAccessProvider.selectInputElement(e[0]), 
        ...
        return function(a, c) {
            ...
            a.editCell = function() {
                ...
                return d && 37 != e.keyCode && 38 != e.keyCode && 39 != e.keyCode && 40 != e.keyCode && 9 != e.keyCode && !e.shiftKey && 13 != e.keyCode && b(a, c), 
                27 == e.keyCode && c.focus(), !0;
            });
        };
    ...
    }), p.directive("ngCell", [ "$compile", "DomUtilityService", function(a, b) {
        var c = {
            scope: !1,
            compile: function() {
                return {
                    pre: function(b, c) {
                        ...
                        var f = a(d)(b);
                        b.enableCellSelection && -1 == f[0].className.indexOf("ngSelectionCell") && (f[0].setAttribute("tabindex", 0), 
                        f.addClass("ngCellElement")), c.append(f);
                    },
                    post: function(a, c) {
        ...
        return c;
    } ]), p.directive("ngGrid", [ "$compile", "$filter", "$templateCache", "SortService", "DomUtilityService", function(a, b, c, d, e) {
        var f = {
            scope: !0,
            compile: function() {
                return {
                    pre: function(f, g, h) {
                        var i = $(g), j = f.$eval(h.ngGrid);
                        j.gridDim = new ng.Dimension({
                            outerHeight: $(i).height(),
                            outerWidth: $(i).width()
                        });
                        var k = new ng.Grid(f, j, d, e, b, c);
                        if ("string" == typeof j.columnDefs ? f.$parent.$watch(j.columnDefs, function(a) {
                            return a ? (f.columns = [], k.config.columnDefs = a, k.buildColumns(), k.configureColumnWidths(), 
                            k.eventProvider.assignEvents(), void e.RebuildGrid(f, k)) : (k.refreshDomSizes(), 
                            void k.buildColumns());
                        }) : k.buildColumns(), "string" == typeof j.data) {
                            var l = function(a) {
                                k.data = $.extend([], a), k.rowFactory.fixRowCache(), angular.forEach(k.data, function(a, b) {
                                    var c = k.rowMap[b] || b;
                                    k.rowCache[c] && k.rowCache[c].ensureEntity(a), k.rowMap[c] = b;
                                }), k.searchProvider.evalFilter(), k.configureColumnWidths(), k.refreshDomSizes(), 
                                k.config.sortInfo && d.sortData(k.config.sortInfo, k.data.slice(0)), f.$emit("ngGridEventData", k.gridId);
                            };
                            f.$parent.$watch(j.data, l), f.$parent.$watch(j.data + ".length", function() {
                                l(f.$eval(j.data));
                            });
                        }
                        return k.footerController = new ng.Footer(f, k), g.addClass("ngGrid").addClass(k.gridId.toString()), 
                        j.jqueryUITheme && g.addClass("ui-widget"), g.append(a(c.get("gridTemplate.html"))(f)), 
                        e.AssignGridContainers(f, g, k), k.eventProvider = new ng.EventProvider(k, f, e), 
                        angular.forEach(j.plugins, function(a) {
                            "function" == typeof a ? a.call(this, []).init(f.$new(), k, {
                                SortService: d,
                                DomUtilityService: e
                            }) : a.init(f.$new(), k, {
                                SortService: d,
                        ...
                        }), j.selectRow = function(a, b) {
                            k.rowCache[a] && k.rowCache[a].setSelection(b ? !0 : !1);
                        }, j.selectItem = function(a, b) {
                            j.selectRow(k.rowMap[a], b);
                        }, j.selectAll = function(a) {
                            f.toggleSelectAll(a);
                        }, j.groupBy = function(a) {
                            if (a) f.groupBy(f.columns.filter(function(b) {
                                return b.field == a;
                            })[0]); else {
                                var b = $.extend(!0, [], f.configGroups);
                                angular.forEach(b, f.groupBy);
                            }
                        }, j.sortBy = function(a) {
                            var b = f.columns.filter(function(b) {
                                return b.field == a;
                            })[0];
                            b && b.sort();
                        }, j.gridId = k.gridId, j.ngGrid = k, j.$gridScope = f, f.$on("ngGridEventDigestGrid", function() {
                            e.digest(f.$parent);
                        }), f.$on("ngGridEventDigestGridParent", function() {
                            e.digest(f.$parent);
                        }), f.$evalAsync(function() {
                            f.adjustScrollLeft(0);
                        }), null;
                    }
                };
            }
        ...
        return f;
    } ]), p.directive("ngHeaderCell", [ "$compile", function(a) {
        var b = {
            scope: !1,
            compile: function() {
                return {
        ...
        return b;
    } ]), p.directive("ngHeaderRow", [ "$compile", "$templateCache", function(a, b) {
        var c = {
            scope: !1,
            compile: function() {
                return {
            ...
            compile: function(a, b, c) {
                return function(a, b, d) {
                    ...
                    a.$watch(d.ngIf, function(d) {
                        e && (e.remove(), e = void 0), f && (f.$destroy(), f = void 0), d && (f = a.$new(), 
                        c(f, function(a) {
                            e = a, b.after(a);
                        }));
                    });
    ...
    } ]), p.directive("ngInput", [ "$parse", function(a) {
        return function(b, c, d) {
    ...
    } ]), p.directive("ngRow", [ "$compile", "DomUtilityService", "$templateCache", function(a, b, c) {
        var d = {
            scope: !1,
            compile: function() {
                return {
                    pre: function(d, e) {
                        if (d.row.elm = e, d.row.clone && (d.row.clone.elm = e), d.row.isAggRow) {
                            ...
                            f = d.row.aggLabelFilter ? f.replace(j, "| " + d.row.aggLabelFilter) : f.replace(j, ""), 
                            e.append(a(f)(d));
        ...
        return function(a, b) {
            ...
            b.bind("scroll", function(b) {
                ...
                return a.$headerContainer && a.$headerContainer.scrollLeft(f), a.adjustScrollLeft(f), 
                a.adjustScrollTop(g), a.$root.$$phase || a.$digest(), d = f, e = e, c = !1, !0;
        ...
        a.put("aggregateTemplate.html", '<div ng-click="row.toggleExpand()" ng-style="{\'left\': row.offsetleft}" class="ngAggregate">    <span class="ngAggregateText">{{row.label CUSTOM_FILTERS}} ({{row.totalChildren()}} {{AggItemsLabel}})</span>    <div class="{{row.aggClass()}}"></div></div>'), 
        a.put("cellEditTemplate.html", '<div ng-cell-has-focus ng-dblclick="editCell()">	<div ng-if="!isFocused">	DISPLAY_CELL_TEMPLATE	</div>	<div ng-if="isFocused">	EDITABLE_CELL_TEMPLATE	</div></div>'), 
        a.put("cellTemplate.html", '<div class="ngCellText" ng-class="col.colIndex()"><span ng-cell-text>{{COL_FIELD CUSTOM_FILTERS}}</span></div>'), 
        a.put("checkboxCellTemplate.html", '<div class="ngSelectionCell"><input tabindex="-1" class="ngSelectionCheckbox" type="checkbox" ng-checked="row.selected" /></div>'), 
        a.put("checkboxHeaderTemplate.html", '<input class="ngSelectionHeader" type="checkbox" ng-show="multiSelect" ng-model="allSelected" ng-change="toggleSelectAll(allSelected)"/>'), 
        a.put("editableCellTemplate.html", '<input ng-class="\'colt\' + col.index" ng-input="COL_FIELD" />'), 
        ...
        a.put("headerCellTemplate.html", '<div class="ngHeaderSortColumn {{col.headerClass}}" ng-style="{\'cursor\': col.cursor}" ng-class="{ \'ngSorted\': !noSortVisible }">    <div ng-click="col.sort($event)" ng-class="\'colt\' + col.index" class="ngHeaderText">{{col.displayName}}</div>    <div class="ngSortButtonDown" ng-show="col.showSortButtonDown()"></div>    <div class="ngSortButtonUp" ng-show="col.showSortButtonUp()"></div>    <div class="ngSortPriority">{{col.sortPriority}}</div>    <div ng-class="{ ngPinnedIcon: col.pinned, ngUnPinnedIcon: !col.pinned }" ng-click="togglePin(col)" ng-show="col.pinnable"></div></div><div ng-show="col.resizable" class="ngHeaderGrip" ng-click="col.gripClick($event)" ng-mousedown="col.gripOnMouseDown($event)"></div>'), 
        a.put("headerRowTemplate.html", '<div ng-style="{\'z-index\': col.zIndex(), height: col.headerRowHeight}" ng-repeat="col in renderedColumns" ng-class="col.colIndex()" class="ngHeaderCell" ng-header-cell></div>'), 
        a.put("rowTemplate.html", '<div ng-style="{\'cursor\': row.cursor, \'z-index\': col.zIndex() }" ng-repeat="col in renderedColumns" ng-class="col.colIndex()" class="ngCell {{col.cellClass}}" ng-cell></div>');
    } ]);
}(window), ngGridFlexibleHeightPlugin = function(a) {
    var b = this;
    b.grid = null, b.scope = null, b.init = function(c, d) {
        ...
        var e = function() {
            ...
            var d = b.grid.gridId, e = "." + d + " .ngTopPanel", f = "." + d + " .ngFooterPanel", g = "." + d + " .ngCanvas", h = "." + d + " .ngViewport", i = $(e).height() + $(f).height(), j = $(g).height() + 15;
            (null == c.baseViewportHeight || 0 == c.baseViewportHeight) && (c.baseViewportHeight = $(h).height()), 
            c.baseViewportHeight > j && (null != a && null != a.minHeight && j + i < a.minHeight && (j = a.minHeight - i - 2), 
            $(h).css("height", j + 2 + "px"), $("." + d).css("height", j + i + 2 + "px")), b.grid.refreshDomSizes();
        };
        c.catHashKeys = function() {
            hash = "";
            for (idx in c.renderedRows) hash += c.renderedRows[idx].$$hashKey;
            return hash;
        }, c.$watch("catHashKeys()", f), c.$watch(d.config.data, e);
    };
}, ngGridLayoutPlugin = function() {
    var a = this;
    this.grid = null, this.scope = null, this.init = function(b, c, d) {
        a.domUtilityService = d.DomUtilityService, a.grid = c, a.scope = b;
    }, this.updateGridLayout = function() {
        a.domUtilityService.RebuildGrid(a.scope, a.grid);
    };
}, ngGridReorderable = function(a) {
    var b = {
        enableHeader: !0,
        enableRow: !0
    }, c = this;
    c.config = $.extend(b, a), c.$scope = null, c.myGrid = null, c.init = function(a, b, d) {
        c.$scope = a, c.myGrid = b, c.services = d, c.assignEvents();
    }, c.colToMove = void 0, c.groupToMove = void 0, c.assignEvents = function() {
        c.myGrid.$groupPanel.on("mousedown", c.onGroupMouseDown).on("dragover", c.dragOver).on("drop", c.onGroupDrop), 
        c.config.enableHeader && c.myGrid.$headerScroller.on("mousedown", c.onHeaderMouseDown).on("dragover", c.dragOver).on("drop", c.onHeaderDrop), 
        c.config.enableRow && c.myGrid.$viewport.on("mousedown", c.onRowMouseDown).on("dragover", c.dragOver).on("drop", c.onRowDrop);
    }, c.dragOver = function(a) {
        a.preventDefault();
    }, c.onGroupDragStart = function() {
        c.groupToMove && c.groupToMove.header.css("background-color", "rgb(255, 255, 204)");
    }, c.onGroupDragStop = function() {
        c.groupToMove && c.groupToMove.header.css("background-color", "rgb(247,247,247)");
    }, c.onGroupMouseDown = function(a) {
        var b = $(a.srcElement);
        if ("ngRemoveGroup" != b[0].className) {
            var d = angular.element(b).scope();
            d && (b.attr("draggable", "true"), b.on("dragstart", c.onGroupDragStart).on("dragend", c.onGroupDragStop), 
            c.groupToMove = {
                header: b,
                groupName: d.group,
                index: d.$index
            });
        } else c.groupToMove = void 0;
    }, c.onGroupDrop = function(a) {
        if (c.groupToMove) {
            c.onGroupDragStop();
            var b = $(a.srcElement).closest(".ngGroupElement");
            if ("ngGroupPanel" == b.context.className) c.$scope.configGroups.splice(c.groupToMove.index, 1), 
            c.$scope.configGroups.push(c.groupToMove.groupName); else {
                var d = angular.element(b).scope();
                d && c.groupToMove.index != d.$index && (c.$scope.configGroups.splice(c.groupToMove.index, 1), 
                c.$scope.configGroups.splice(d.$index, 0, c.groupToMove.groupName));
            }
            c.groupToMove = void 0;
        } else c.onHeaderDragStop(), -1 == c.$scope.configGroups.indexOf(c.colToMove.col) && c.$scope.configGroups.push(c.colToMove.col), 
        c.colToMove = void 0;
        c.$scope.$digest();
    }, c.onHeaderMouseDown = function(a) {
        var b = $(a.srcElement).closest(".ngHeaderSortColumn"), d = angular.element(b).scope();
        d && (b.attr("draggable", "true"), b.on("dragstart", c.onHeaderDragStart).on("dragend", c.onHeaderDragStop), 
        c.colToMove = {
            header: b,
            col: d.col
        });
    }, c.onHeaderDragStart = function() {
        c.colToMove && c.colToMove.header.css("background-color", "rgb(255, 255, 204)");
    }, c.onHeaderDragStop = function() {
        c.colToMove && c.colToMove.header.css("background-color", "rgb(234, 234, 234)");
    }, c.onHeaderDrop = function(a) {
        if (c.colToMove) {
            c.onHeaderDragStop();
            var b = $(a.srcElement).closest(".ngHeaderSortColumn"), d = angular.element(b).scope();
            if (d) {
                if (c.colToMove.col == d.col) return;
                c.$scope.columns.splice(c.colToMove.col.index, 1), c.$scope.columns.splice(d.col.index, 0, c.colToMove.col), 
                angular.forEach(c.$scope.columns, function(a, b) {
                    a.index = b;
                }), c.myGrid.cssBuilder.buildStyles(), c.colToMove = void 0;
            }
        }
    }, c.onRowMouseDown = function(a) {
        var b = $(a.srcElement).closest(".ngRow"), d = angular.element(b).scope();
        d && (b.attr("draggable", "true"), c.services.GridService.eventStorage.rowToMove = {
            targetRow: b,
            scope: d
        });
    }, c.onRowDrop = function(a) {
        var b = $(a.srcElement).closest(".ngRow"), d = angular.element(b).scope();
        if (d) {
            var e = c.services.GridService.eventStorage.rowToMove;
            if (e.scope.row == d.row) return;
            var f = c.myGrid.sortedData.indexOf(e.scope.row.entity), g = c.myGrid.sortedData.indexOf(d.row.entity);
            c.myGrid.sortedData.splice(f, 1), c.myGrid.sortedData.splice(g, 0, e.scope.row.entity), 
            c.myGrid.rowFactory.sortedDataChanged(c.myGrid.sortedData), c.services.GridService.eventStorage.rowToMove = void 0;
        }
    };
};
 ...
 * License: MIT
 */
var claimItemServices = angular.module("claimItemServices", [ "ngResource" ]), claimMaintenanceControllers = angular.module("claimMaintenanceControllers", []);

claimItemServices.factory("ClaimItemsAll", [ "$resource", function(a) {
    return a("/claims-estimator-mvc/service/claimitems", {}, {
        query: {
            method: "GET",
            isArray: !0
        }
    });
} ]), claimMaintenanceControllers.controller("ClaimItemMaintenanceController", [ "$scope", "ClaimItemsAll", function(a, b) {
    a.claimItems = b.query(), a.orderProp = "claimItemName", a.totalServerItems = a.claimItems.length, 
    a.gridOptions = {
        data: "claimItems",
        columnDefs: [ {
            field: "claimItemName",
