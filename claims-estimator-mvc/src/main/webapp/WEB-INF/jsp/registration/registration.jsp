						...
						<form role="form" class="form-horizontal">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-lg-10">
										<input type="email" class="form-control" id="emailAddress"
											ng-model="userRegistration.emailAddress" autocomplete="off"
								...
								<div class="form-group">
									...
									<div class="col-lg-10">
										<input type="password" class="form-control" id="inputPassword"
											ng-model="userRegistration.password" autocomplete="off"
											style="background-image: url(data:image/png;base64,); background-attachment: scroll; background-position: 100% 50%; background-repeat: no-repeat;">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" id="firstName"
											ng-model="userRegistration.firstName" autocomplete="off"
											style="background-image: url(data:image/png;base64,); background-attachment: scroll; background-position: 100% 50%; background-repeat: no-repeat;">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" id="lastName"
											ng-model="userRegistration.lastName" autocomplete="off"
											style="background-image: url(data:image/png;base64,); background-attachment: scroll; background-position: 100% 50%; background-repeat: no-repeat;">
									</div>
								</div>

								<div class="form-group">
									<label for="address1" class="col-lg-2 control-label">Address
										Line 1</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" id="address1"
											ng-model="userRegistration.address1" autocomplete="off"
											style="background-image: url(data:image/png;base64,); background-attachment: scroll; background-position: 100% 50%; background-repeat: no-repeat;">
									</div>
								</div>

								<div class="form-group">
									<label for="address2" class="col-lg-2 control-label">Address
										Line 2</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" id="address2"
											ng-model="userRegistration.address2" autocomplete="off">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" id="city"
											ng-model="userRegistration.city" autocomplete="off">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-10">
										<select ng-model="stateSelected"
											ng-options="s.name for s in states" class='form-control'></select>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" id="zip"
											ng-model="userRegistration.zip" autocomplete="off">
									</div>
								</div>

								<button type="submit" class="btn btn-primary"
									ng-click="save(userRegistration)" value="Save">Submit</button>
							</fieldset>
						</form>
					</div>
				</div>
